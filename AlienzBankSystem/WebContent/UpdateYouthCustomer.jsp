...
<title>Update Youth Customer</title>
<!-- styles -->
            ...
            <tr>
                <th>
                    ...
                    <div class="formstyle1">
                            ...
                            <h1 id="topic"> Update My Profile </h1>
                        ...
                        First name:&emsp;&emsp;&emsp;&emsp;&emsp; <input type="text" name="fname" placeholder="First Name"  value="<%= fname %>" ><br></br>

                        Last name     :&emsp;&emsp;&emsp;&emsp;&emsp;<input type="text" id="lname" name="lname" placeholder="Last name" value="<%= lname %>"><br><br> 
                        
                        
                        Address :<br></br>

                        <textarea name="address" rows="7" cols="50" value="<%= address %>" required> </textarea><br></br>
                        <br></br>
                        
                        Your NIC Number:&emsp;&emsp;&emsp;&emsp;&emsp; <input type="text" name="nic" placeholder="name" value="<%= NIC %>" readonly><br></br>
                        
                        Contact Number:
                        &nbsp;&emsp;&emsp;<input type="tel" id="phone" name="phonenumber" placeholder="1234-567-890" pattern="[0-9]{10}" value="<%= phonenumber %>" required>
                        <br></br>
                        
                         E-Mail Address:
                        <div class="input">
                         &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="text" name="email" id="email" placeholder="Email address" value="<%= email %>" required onkeyup="validateEmail()">
                        ...
                        <span id="emailMsg"></span>
                            ...
                            <br></br>
                           <button type="submit" id="smtbtn" name="btnsubmit" value="submit">Update my profile</button>
                            <br>
